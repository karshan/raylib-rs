...
impl Matrix {
    ...
    pub fn identity() -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixIdentity())
        }
    }
    ...
    pub fn translate(x: f32, y: f32, z: f32) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixTranslate(x, y, z))
        }
    }
    ...
    pub fn rotate(axis: Vector3, angle: f32) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixRotate(axis.into(), angle))
        }
    }
    ...
    pub fn rotate_x(angle: f32) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixRotateX(angle))
        }
    }
    ...
    pub fn rotate_y(angle: f32) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixRotateY(angle))
        }
    }
    ...
    pub fn rotate_z(angle: f32) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixRotateZ(angle))
        }
    }
    ...
    pub fn rotate_xyz(ang: Vector3) -> Self {
        unsafe {
            Matrix::from(ffi::MatrixRotateXYZ(ang.into()))
        }
    }
    ...
    pub fn scale(x: f32, y: f32, z: f32) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixScale(x, y, z))
        }
    }
    ...
    pub fn frustum(left: f64, right: f64, bottom: f64, top: f64, near: f64, far: f64) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixFrustum(left, right, bottom, top, near, far))
        }
    }
    ...
    pub fn perspective(fovy: f64, aspect: f64, near: f64, far: f64) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixPerspective(fovy, aspect, near, far))
        }
    }
    ...
    pub fn ortho(left: f64, right: f64, bottom: f64, top: f64, near: f64, far: f64) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixOrtho(left, right, bottom, top, near, far))
        }
    }
    ...
    pub fn look_at(eye: Vector3, target: Vector3, up: Vector3) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixLookAt(eye.into(), target.into(), up.into()))
        }
    }
    ...
    pub fn determinant(&self) -> f32 {
        unsafe {
            ffi::MatrixDeterminant(self.into())
        }
    }
    ...
    pub fn transposed(&self) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixTranspose(self.into()))
        }
    }
    ...
    pub fn inverted(&self) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixInvert(self.into()))
        }
    }
...
impl Add for Matrix {
    ...
    fn add(self, mat: Matrix) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixAdd(self.into(), mat.into()))
        }
    }
}
...
impl Sub for Matrix {
    ...
    fn sub(self, mat: Matrix) -> Matrix {
        unsafe {
            Matrix::from(ffi::MatrixSubtract(self.into(), mat.into()))
        }
    }
}
...
impl Mul for Matrix {
    ...
    fn mul(self, mat: Matrix) -> Matrix {
        unsafe {
            // Raylib mutliplies matrices backwards https://github.com/raysan5/raylib/issues/3039
            Matrix::from(ffi::MatrixMultiply(mat.into(), self.into()))
        }
    }
}
